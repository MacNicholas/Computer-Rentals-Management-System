...
<head>
	...
	<title>CRS Update Computer</title>
								...
								<div class="card-body card-block">
									<?php
                                            ...
                                            while ($row = mysqli_fetch_array($ret)) {
                                                ...
                                                ?>
									<div class="form-group"><label for="company" class=" form-control-label">Computer
											Name</label><input type="text" name="compname"
											value="<?php echo $row['ComputerName']; ?>" class="form-control"
											id="compname" required="true"></div>

									<div class="form-group"><label for="street" class=" form-control-label">Computer
											Location</label><input type="text" name="comploc"
											value="<?php echo $row['ComputerLocation']; ?>" id="comploc"
											class="form-control" required="true"></div>
									<div class="row form-group">
										<div class="col-12">
											<div class="form-group"><label for="city" class=" form-control-label">ID
													Address</label><input type="text" name="idadd" id="idadd"
													value="<?php echo $row['IPAdd']; ?>" class="form-control"
													required="true"></div>
										</div>
